  ...
  const handleFeed = async (useRecommended = true) => {
    ...
    try {
      ...
      await set(eventRef, {
        ...
        type: "feedingRequest", // Changed from "feeding" to "feedingRequest"
        description: `Requested ${gramsToDispense}g of feed for ${chickenCount} ${ageGroup} chickens (${useRecommended ? "recommended" : "custom"} amount)`,
      })
